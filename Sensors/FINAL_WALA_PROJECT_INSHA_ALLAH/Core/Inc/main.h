...
#define FRONT_QTR_6_Pin GPIO_PIN_0
#define FRONT_QTR_6_GPIO_Port GPIOC
#define FRONT_QTR_7_Pin GPIO_PIN_1
#define FRONT_QTR_7_GPIO_Port GPIOC
#define FRONT_QTR_8_Pin GPIO_PIN_2
#define FRONT_QTR_8_GPIO_Port GPIOC
#define SHARP_IR_Pin GPIO_PIN_3
#define SHARP_IR_GPIO_Port GPIOC
#define ARDUINO_START_Pin GPIO_PIN_2
#define ARDUINO_START_GPIO_Port GPIOF
#define FRONT_QTR_1_Pin GPIO_PIN_0
#define FRONT_QTR_1_GPIO_Port GPIOA
#define FRONT_QTR_2_Pin GPIO_PIN_1
#define FRONT_QTR_2_GPIO_Port GPIOA
#define FRONT_QTR_3_Pin GPIO_PIN_2
#define FRONT_QTR_3_GPIO_Port GPIOA
#define FRONT_QTR_4_Pin GPIO_PIN_3
#define FRONT_QTR_4_GPIO_Port GPIOA
#define RIGHT_QTR_6_Pin GPIO_PIN_4
#define RIGHT_QTR_6_GPIO_Port GPIOF
#define FRONT_QTR_5_Pin GPIO_PIN_4
#define FRONT_QTR_5_GPIO_Port GPIOA
#define RIGHT_QTR_3_Pin GPIO_PIN_5
#define RIGHT_QTR_3_GPIO_Port GPIOC
#define LEFT_QTR_6_Pin GPIO_PIN_0
#define LEFT_QTR_6_GPIO_Port GPIOB
#define RIGHT_QTR_1_Pin GPIO_PIN_1
#define RIGHT_QTR_1_GPIO_Port GPIOB
#define RIGHT_QTR_6B2_Pin GPIO_PIN_2
#define RIGHT_QTR_6B2_GPIO_Port GPIOB
#define LEFT_QTR_5_Pin GPIO_PIN_7
#define LEFT_QTR_5_GPIO_Port GPIOE
...
#define RIGHT_QTR_2_Pin GPIO_PIN_12
#define RIGHT_QTR_2_GPIO_Port GPIOB
#define RIGHT_QTR_3B13_Pin GPIO_PIN_13
#define RIGHT_QTR_3B13_GPIO_Port GPIOB
#define RIGHT_QTR_4_Pin GPIO_PIN_14
#define RIGHT_QTR_4_GPIO_Port GPIOB
#define RIGHT_QTR_5_Pin GPIO_PIN_15
...
#define LEFT_QTR_1_Pin GPIO_PIN_10
#define LEFT_QTR_1_GPIO_Port GPIOD
#define LEFT_QTR_2_Pin GPIO_PIN_11
#define LEFT_QTR_2_GPIO_Port GPIOD
#define GYRO_CS_Pin GPIO_PIN_12
#define GYRO_CS_GPIO_Port GPIOD
#define LEFT_QTR_3_Pin GPIO_PIN_13
#define LEFT_QTR_3_GPIO_Port GPIOD
#define LEFT_QTR_4_Pin GPIO_PIN_14
#define LEFT_QTR_4_GPIO_Port GPIOD
