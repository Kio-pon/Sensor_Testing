...
typedef struct {
    ...
    float filtered_distance;    /* EMA Filtered Distance */
} SharpSensor_t;

/* Global state variables (added for NERC integration) */
extern volatile float sharp_cm_front;
extern volatile float sharp_cm_left;
extern volatile float sharp_cm_right;
