...
static HAL_StatusTypeDef TCS_WriteReg(I2C_HandleTypeDef *hi2c, uint8_t reg, uint8_t val)
{
    uint8_t buf[2];
...
static HAL_StatusTypeDef TCS_ReadReg(I2C_HandleTypeDef *hi2c, uint8_t reg, uint8_t *val)
{
